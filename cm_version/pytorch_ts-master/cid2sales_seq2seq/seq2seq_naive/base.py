...
class Feature_Flow_SKU:
    ...
    def create_ts_samples(self, X, y, feature_cols, encoder_seq_len, output_seq_len, skip_period, mode='train'):
        ...
        if mode == 'train':
            ...
            start_points = list(
                range((len(X) - encoder_seq_len - output_seq_len + skip_period) // skip_period))
        else:
        ...
        decoder_points = [list(range(start_point * skip_period + encoder_seq_len,
                                     min(start_point * skip_period + encoder_seq_len + output_seq_len,
                                         len(X))))
                          for start_point in start_points]
